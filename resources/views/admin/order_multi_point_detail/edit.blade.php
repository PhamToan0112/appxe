...
@section('content')
    <div class="page-body">
        <div class="container-xl">
            <x-form :action="route('admin.multiPointDetail.update')" type="put" :validate="true">
                <x-input type="hidden" name="id" :value="$orderMultiPointDetail->id" />
                <x-input type="hidden" name="editPage" value="true" />
                <div class="row justify-content-center">
                    @include('admin.order_multi_point_detail.forms.edit-left')
                    @include('admin.order_multi_point_detail.forms.edit-right')
                </div>
