...
@section('content')
    <div class="page-body">
        <div class="container-xl">
            <x-form :action="route('admin.cMulti.shipment.update')" type="put" :validate="true">
                <x-input type="hidden" name="id" :value="$shipment->id" />
                <x-input type="hidden" name="editPage" value="true" />
                <div class="row justify-content-center">
                    @include('admin.shipment.forms.edit-left')
                    @include('admin.shipment.forms.edit-right')
                </div>
