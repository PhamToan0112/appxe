        ...
        <div class="container-xl">
            <div class="card">
                <div class="card-header justify-content-between">
                    <h2 class="mb-0">
                        @if (request()->routeIs('admin.discount.index'))
                            @lang('listDiscount')
                        @elseif(request()->routeIs('admin.discount.expired'))
                            {{ __('Danh sách mã giảm giá đã hết hạn') }}
                        @endif

                    </h2>
                    <x-link :href="route('admin.discount.create')" class="btn btn-primary">
