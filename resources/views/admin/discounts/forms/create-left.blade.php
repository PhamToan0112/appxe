<div class="col-12 col-md-9">
    <div class="card">
        <div class="card-header" style="justify-content: center";>
            <h2 style="justify-content: center;  color: red;">Tạo phiếu giảm giá </h2>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body row">
                            ...
                            <div class="mb-3">
                                ...
                                <x-select name="type" :required="true" id="discount_type">
                                    @foreach ($types as $key => $value)
                                        <x-select-option :value="$key" :title="$value" :selected="$key === \App\Enums\Discount\DiscountType::Percent->value" />
                                    @endforeach
                                </x-select>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                <div id="discount_money" class="d-none">
                                    <label class="control-label">@lang('Giá trị giảm') (VND)</label>
                                ...
                                <div id="discount_percent">
                                    <label class="control-label">@lang('Giá trị giảm') (%)</label>
                        ...
                        <div class="row">
                            ...
                            <!-- user -->
                            <div class="col-md-12  d-none" id="select_user">
                                <div class="mb-3">
                        ...
                        <div class="row">
                            ...
                            <!-- driver -->
                            <div class="col-md-12 d-none" id="select_driver">
                                <div class="mb-3">
