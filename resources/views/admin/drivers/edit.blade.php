    ...
    <div class="page-body">
        <div class="container-xl">
            <x-form :action="route('admin.driver.update')" type="put" :validate="true" enctype="multipart/form-data">
                ...
                <x-input type="hidden" id="wallet_id" name="wallet_id" :value="$driver->user->wallet->id"/>
...
@push('custom-js')
    ...
    @include('admin.scripts.balance')
    @include('admin.users.scripts.deposit')
    @include('admin.users.scripts.withdraw')
