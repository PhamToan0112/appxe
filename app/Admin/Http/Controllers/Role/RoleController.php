...
class RoleController extends Controller
{
    ...
    public function index(RoleDataTable $dataTable){
        ...
        return $dataTable->render($this->view['index'],
            [
                'breadcrumbs' => $this->crums->add(__('role')),
            ]
        );
    }
    ...
    public function create(){
        ...
        return view($this->view['create'],[
            ...
            'breadcrumbs' => $this->crums->add(__('role'),route($this->route['index']))->add(__('add')),
		]);
    }
    ...
    public function edit($id){
        ...
        return view(
            ...
            [
				...
				'listPermissionsInAllModules' => $listPermissionsInAllModules,
                'breadcrumbs' => $this->crums->add(__('role'),route($this->route['index']))->add(__('edit')),
