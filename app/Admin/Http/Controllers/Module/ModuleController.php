...
class ModuleController extends Controller
{
    ...
    public function summary(): Factory|View|Application
    {
        ...
        return view($this->view['summary'], [
            ...
            'breadcrumbs' => $this->crums->add(__('summary')),
        ]);
    }
    ...
    public function create(): Factory|View|Application
    {
        ...
        return view($this->view['create'], [
            ...
            'breadcrumbs' => $this->crums->add(__('Module'),route($this->route['index']))->add(__('add')),
        ]);
    }
    ...
    public function edit($id): Factory|View|Application
    {
        ...
        return view(
            ...
            [
                ...
                'listpermissions' => $listpermissions,
                'status' => ModuleStatus::asSelectArray(),
                'breadcrumbs' => $this->crums->add(__('Module'),route($this->route['index']))->add(__('edit')),
            ]
        );
