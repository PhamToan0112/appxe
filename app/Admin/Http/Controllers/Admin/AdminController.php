...
class AdminController extends Controller
{
    ...
    public function index(AdminDataTable $dataTable){
        ...
        [
            'breadcrumbs' => $this->crums->add(__('admin')),
        ]
    );
    }
    ...
    public function create(): Factory|View|Application
    {
        ...
        return view($this->view['create'], [
			'roles' => $roles,
            'breadcrumbs' => $this->crums->add(__('admin'),route($this->route['index']))->add(__('add')),
		]);
    }
    ...
    public function edit($id): Factory|View|Application
    {
        ...
        return view(
			...
			[
                'admin' => $instance,
				'roles' => $roles,
                'breadcrumbs' => $this->crums->add(__('admin'),route($this->route['index']))->add(__('edit')),
