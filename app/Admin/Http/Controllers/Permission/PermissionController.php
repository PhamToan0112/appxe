...
class PermissionController extends Controller
{
    ...
    public function index(PermissionDataTable $dataTable){
        ...
        return $dataTable->render($this->view['index'],
            [
                'breadcrumbs' => $this->crums->add(__('permissionList'))
            ]
        );
    }
    ...
    public function create(){
        ...
        return view($this->view['create'], [
            ...
            'breadcrumbs' => $this->crums->add(__('permissionList'),route($this->route['index']))->add(__('add')),
		]);
    }
    ...
    public function edit($id){
        ...
        return view(
            ...
            [
				'listmodules' => $listmodules,
                'permission' => $response,
                'breadcrumbs' => $this->crums->add(__('permissionList'),route($this->route['index']))->add(__('edit')),
            ]
        );
