...
class SettingController extends Controller
{
     ...
     *     "type_data": null,
     *     "group": 10,
     *     "created_at": "02-12-2024 22:38",
     *     "updated_at": "02-12-2024 22:38"
     * }
    *      ]
     * }
     *
     ...
     *             "type_data": null,
     *             "group": 10,
     *             "created_at": "21-10-2024 17:28",
     *             "updated_at": "21-10-2024 17:28"
     *         },
     *         {
     *             "id": 45,
     *             "setting_key": "c_multi",
    ...
    public function c_multi(): JsonResponse
    {
        try {
            $cMulti = $this->settingRepository->getByGroup([SettingGroup::C_Multi]);
            $settingResponse = SettingResource::collection($cMulti);

            return $this->jsonResponseSuccess($settingResponse);
        } catch (Exception $e) {
            $this->logError('C_Multi setting failed:', $e);
            return $this->jsonResponseError('C_Multi setting failed', 500);
        }
    }
}